...
namespace Royale.Pages
{
    ...
    public class CopyDeckPageMap
    {
        ...
        public Element CopiedMessage => Driver.FindElement(By.CssSelector(".notes.active"), "Copy Message");
        ...
        public Element GooglePlayButton => Driver.FindElement(By.XPath("//a[text()='Google Play']"), "Play Store Button");
